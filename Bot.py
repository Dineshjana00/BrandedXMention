...
async def start(event):
    ...
    await event.client.send_file(
        ...
        link_preview=False,
        buttons=[
            [Button.url("❤️‍🔥 ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ 💫", "https://t.me/Callmemberbot")],
            [Button.url("❤️‍🔥 ɢʀᴏᴜᴘ 💫", "https://t.me/crazzysuport"), Button.url("❤️‍🔥 ᴄʜᴀɴɴᴇʟ 💫", "https://https://t.me/Crazzyupdate")],
        ]
    )
